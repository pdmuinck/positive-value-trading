...
//let circusWS = new WebSocket("wss://magicbetting.be/api/234/nmbzjqkk/websocket", null, {rejectUnauthorized: false})
...
event.getBySport = async (sport) => {
    ...
    circusWS.on('open', function open() {
        ...
        */
        ...
        circusWS.send(JSON.stringify(["SUBSCRIBE\nid:/api/eventgroups/soccer-int10-sb_type_19162-all-match-events-grouped-by-type\ndestination:/api/eventgroups/soccer-int10-sb_type_19162-all-match-events-grouped-by-type\nlocale:nl\n\n\u0000"]))
