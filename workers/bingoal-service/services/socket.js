/* sockjs-client v1.4.0 | http://sockjs.org | MIT license */ ! function(t) {
    ...
    return function i(s, a, l) {
        ...
        5: [function(t, e, n) {
            ...
            r.prototype.addEventListener = function(t, e) {
                ...
                if (n) {
                    var r = n.indexOf(e); - 1 === r || (1 < n.length ? this._listeners[t] = n.slice(0, r).concat(n.slice(r + 1)) : delete this._listeners[t])
                }
        ...
        15: [function(t, e, n) {
            ...
            d(u, {
                indexOf: function(t, e) {
                    ...
                    }(e)), o = 0 <= o ? o : Math.max(0, r + o); o < r; o++)
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function(t, e) {
                ...
                for (t = new RegExp(t.source, l + "g"), n += "", _ || (r = new RegExp("^" + t.source + "$(?!\\s)", l)), e = void 0 === e ? -1 >>> 0 : function(t) {
                    return t >>> 0
                     ...
                     (o = t.exec(n)) && !(c < (i = o.index + o[0].length) && (a.push(n.slice(c, o.index)), !_ && 1 < o.length && o[0].replace(r, function() {
            ...
            (function(i) {
                ...
                t(u, l), u.prototype.abort = function() {
                    ...
                    if (r.id = "a" + s.string(8), r.src = t, r.type = "text/javascript", r.charset = "UTF-8", r.onerror = this._scriptError.bind(this), r.onload = function() {
                        ...
                        if (a.isOpera())(e = this.script2 = i.document.createElement("script")).text = "try{var a = document.getElementById('" + r.id + "'); if(a)a.onerror();}catch(x){};", r.async = e.async = !1;
                        else {
                            try {
        ...
        55: [function(t, a, l) {
            (function(s) {
                (function() {
                    ...
                    function W(t, l) {
                        ...
                        if (!d("json")) {
                            ...
                            if ((j = i.hasOwnProperty) || (j = function(t) {
                                var n, e = {};
                                return j = (e.__proto__ = null, e.__proto__ = {
                                    "toString": 1
                                }, e).toString != O ? function(t) {
                                ...
                                var m = {
                                    ...
                                    R = function(t, e, n, r, o, i, s) {
                                        ...
                                        if ("object" == typeof a && a)
                                            if ("[object Date]" != (l = O.call(a)) || j.call(a, "toJSON")) "function" == typeof a.toJSON && (l != C && l != N && l != A || j.call(a, "toJSON")) && (a = a.toJSON(t));
                                            else if (-1 / 0 < a && a < 1 / 0) {
                                                if (I) {
                                    ...
                                    for (var t, e, n, r, o, i = w, s = i.length; g < s;) switch (o = i.charCodeAt(g)) {
                                        ...
                                        case 34:
                                            for (t = "@", g++; g < s;)
                                                ...
                                                else if (92 == o) switch (o = i.charCodeAt(++g)) {
                                                    case 92:
                                                    case 34:
                                                    case 47:
                                                    case 98:
                                ...
                                var g, w, x = u.fromCharCode,
                                    ...
                                    U = function(t) {
                                        ...
                                        if ("$" == t && v(), "string" == typeof t) {
                                            ...
                                            if ("[" == t) {
                                                for (e = [];
                                                     "]" != (t = b()); n = n || !0) n && ("," == t ? "]" == (t = b()) && v() : v()), "," == t && v(), e.push(U(t));
                                                return e
                                            }
                                            if ("{" == t) {
                                                for (e = {};
                                                     "}" != (t = b()); n = n || !0) n && ("," == t ? "}" == (t = b()) && v() : v()), "," != t && "string" == typeof t && "@" == (a ? t.charAt(0) : t[0]) && ":" == b() || v(), e[t.slice(1)] = U(b());
                                                return e
                                            }
                                            v()
                                        }
                    ...
                    if (!e || e.global !== e && e.window !== e && e.self !== e || (D = e), t) W(D, t);
                    else {
                        var n = D.JSON,
                            r = D.JSON3,
                            o = !1,
