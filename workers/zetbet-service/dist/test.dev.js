...
event.getById = function _callee(id) {
...
event.getByIdEuroTierce = function _callee2(id) {
  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", axios.get('https://sports.eurotierce.be/nl/event/3326165-milan-ac-celtic-glasgow').then(function (response) {
