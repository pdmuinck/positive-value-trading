...
participantMap[ParticipantName.MOESKROEN] = ["ROYAL EXCEL MOUSCRON", "MOUSCRON", "MOUSCRON PERUWELZ", "ROYAL MOUSCRON", "ROYAL MOUSCRON-PERUWELZ"]
participantMap[ParticipantName.GENK] = ["GENK", "KRC GENK", "K.R.C. GENK", "RACING GENK"]
participantMap[ParticipantName.WAASLAND_BEVEREN] = ["WAASLAND-BEVEREN", "WAASLAND BEVEREN"]
participantMap[ParticipantName.GENT] = ["GENT", "AA GENT", "K.A.A. GENT", "KAA GENT", "GHENT"]
