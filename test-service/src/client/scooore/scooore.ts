...
export function parseScoooreBetOffers(apiResponse: ApiResponse): BetOffer[] {
...
function determineOutcome(betType: BetType, selection) {
...
function determineBetType(betType): BetType {
    switch(betType){
