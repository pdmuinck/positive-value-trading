import {BetType, Bookmaker, BookmakerId, Provider} from "../../valuebet-service-ts/src/service/bookmaker";
import {BookMakerInfo, EventInfo} from "../../valuebet-service-ts/src/service/events";
import {magicbetting_sportradar} from "./participants";
import {BetOffer} from "../../valuebet-service-ts/src/service/betoffers";
import {calculateMargin} from "../../valuebet-service-ts/src/client/utils";
...
export async function getPlaytechEventsForCompetition(id: string, sportRadarMatches) {
...
export async function getPlaytechBetOffers(marketIds): Promise<BetOffer[]> {
    const ws = startMagicBettingWS()
    ws.on('open', function open() {
